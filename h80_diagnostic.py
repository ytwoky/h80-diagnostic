...
class DiagnosticApp:
    ...
    def _recommendation(result: AnalysisResult) -> str:
        ...
        if result.ra > RA_LIMIT_CRIT or result.di >= 70.0:
            return "  Критический уровень деградации (Ra/DI). Требуется промывка ПЧ, повторный контроль и оценка необходимости ремонта."
